...
if(marujos >= 10){
    ...
    if(comidaPorMarujo >= 1.5){
        ...
        diasExtras = dias - 1
        alert("Você poderá ficar por mais "+diasExtras.toFixed(0)+" dias no mar.")
    }
    else{
        ...
        alert("Você precisa de mais "+comidaFaltante+" kg de comida.")
    }
}
else{
    alert("Algo está errado. Posseidom não quer ninguém no mar hoje.")
    marujosFaltante = 10 - marujos
    alert("Você precisa de mais "+marujosFaltante+" marujos.")
}